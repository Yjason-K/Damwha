...
import { postmasterArgs, spawnPostmaster, stopPostmaster, type PostmasterSignal } from "../../../src/services/postgres/handle";
import { pgBinaries, pgLayout } from "../../../src/services/postgres/layout";
...
describe("spawnPostmaster", () => {
  ...
  it("keeps SIGKILL and group signals out of the source", () => {
    const src = fs.readFileSync(path.join(__dirname, "..", "..", "..", "src", "services", "postgres", "handle.ts"), "utf8");
